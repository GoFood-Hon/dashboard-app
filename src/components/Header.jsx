...
export default function Header() {
  return (
    <div className="w-full p-4 flex flex-row justify-between text-black dark:text-white bg-white dark:bg-slate-800 dark:border-slate-700 border border-gray-200">
